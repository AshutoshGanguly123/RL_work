...
vec_env = make_vec_env("HalfCheetah-v4", n_envs=10)

# Evaluation callback to log rewards and other stats every 1000 steps
eval_callback = EvalCallback(
    vec_env,
    best_model_save_path="/Users/ashutoshganguly/Desktop/personal/RL_work/ppo_mujoco/halfcheetah-v4/model",
    log_path="/Users/ashutoshganguly/Desktop/personal/RL_work/ppo_mujoco/halfcheetah-v4/logs",
