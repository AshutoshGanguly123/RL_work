...
class Agent():
    def __init__(self,gamma, epsilon, lr, input_dims, batch_size, fc1_dims, fc2_dims, n_actions, max_mem_size = 100000, eps_end = 0.01, eps_dec= 5e-4):
        self.gamma = gamma
        ...
        self.mem_cntr = 0
        self.Q_eval = DeepQNetwork(self.lr, input_dims, fc1_dims, fc2_dims, n_actions)
    ...
    def learn(self):
        ...
        terminal_batch = T.tensor(np.array(self.terminal_memory[batch]), dtype=T.bool).to(self.Q_eval.device)
